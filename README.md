...
<p align="center">
  ...
  ·
  <a href="星港拾荒者-v0.1.0-v0.14.0-Patch-Notes.txt">完整更新记录</a>
  ·
...
完整版本变化见 [Patch Notes](星港拾荒者-v0.1.0-v0.14.0-Patch-Notes.txt)。
...
测试覆盖后期数值压缩、旧存档迁移、后台收益、任务进度与版本检测、舰队购买、战斗材料、星港增幅、伴星展示，以及手机省电和后台暂停策略。
