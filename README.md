...
<p align="center">
  ...
  ·
  <a href="星港拾荒者-v0.1.0-v0.25.0-Patch-Notes.txt">完整更新记录</a>
  ·
...
完整版本变化见 [Patch Notes](星港拾荒者-v0.1.0-v0.25.0-Patch-Notes.txt)。
...
云端配置说明见 [FIREBASE-SETUP.txt](FIREBASE-SETUP.txt)，公告发布与反馈处理流程见 [COMMUNICATIONS-GUIDE.txt](COMMUNICATIONS-GUIDE.txt)，换电脑继续开发请先阅读 [新电脑维护交接说明-v0.25.0.md](新电脑维护交接说明-v0.25.0.md)。
