...
<p align="center">
  ...
  ·
  <a href="星港拾荒者-v0.1.0-v0.13.8-Patch-Notes.txt">完整更新记录</a>
  ·
...
- **观赏伴星**：奇点坍缩会永久唤醒伴星；已收藏伴星会作为实体天体环绕指挥台信标。
- **排行榜**：登录后可比较累计星尘、最高综合战力和战斗次数。
...
- v0.13.7：修复自动产量达到 999K/秒后停止增长的问题，同时提高后期产量显示精度。
- 后期自动产量使用递减曲线控制在低 M 级，避免重新膨胀到 B、T、P 级数字。

完整版本变化见 [Patch Notes](星港拾荒者-v0.1.0-v0.13.8-Patch-Notes.txt)。
...
测试覆盖后期数值压缩、旧存档迁移、后台收益、舰队购买、战斗材料、星港增幅、伴星展示，以及手机省电和后台暂停策略。
